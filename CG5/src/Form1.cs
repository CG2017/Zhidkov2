...
namespace lab5
{
    public partial class Form1 : Form
    {
        ...
        private static bool PutPixel(Bitmap image, int x0, int y0)
        {
            ...
            {
                image.SetPixel(x0, y0, Color.Green);
        ...
        private static void PutPixel(Bitmap image, int x0, int y0, int a)
        {
            if (x0 < 0 || y0 < 0 || x0 > image.Width - 1 || y0 > image.Height - 1)
                return;
            image.SetPixel(x0, y0, Color.FromArgb(a, Color.Green));
        }
        ...
        private void DrawCoord(Bitmap bitmap)
        {
            ...
            {
                PutPixel(bitmap, 0, i, Color.Black);
                if (i%10 == 0)
                    PutPixel(bitmap, 1, i, Color.Black);
            }
            for (var i = 0; i < bitmap.Width; i++)
            {
                PutPixel(bitmap, i, 0, Color.Black);
                if (i%10 == 0)
                    PutPixel(bitmap, i, 1, Color.Black);
            }
        }
